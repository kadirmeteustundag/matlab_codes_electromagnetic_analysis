...
electromagneticProperties(emagmodel,RelativePermeability=mu_R_conductor,Face=1);
%}
mu_R_dielectric_medium = input("Relative Permeability of Dielectric Medium: ");
electromagneticProperties(emagmodel,RelativePermeability=mu_R_dielectric_medium,Face=3);
...
figure;
mesh_Hmax = generateMesh(emagmodel,"Hmax",10,"Hedge",{5:13,2});
pdemesh(mesh_Hmax)
%
