...
SQ1 = [3; 4; 1; 3; 3; 1; 1; 1; 1.1; 1.1];
SQ2 = [3; 4; 1; 3; 3; 1; 2.9; 2.9; 3; 3];
SQ3 = [3; 4; 0; 4; 4; 0; 0; 0; 4; 4];
...
figure;
plot(R.ElectricField.Ex)
figure;
plot(R.ElectricField.Ey)
figure;
plot(sqrt(R.ElectricField.Ex.^2+R.ElectricField.Ey.^2))